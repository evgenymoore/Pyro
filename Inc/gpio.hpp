...
#define TXD                     ((uint16_t)0x0200)      /* PA9 */
#define RXD                     ((uint16_t)0x0400)      /* PA10 */
#define RE_DE                   ((uint16_t)0x0800)      /* PA11 */

        /* SPI pin configuration */
#define SCLK                    ((uint16_t)0x0004)      /* PA2 */
#define SDI                     ((uint16_t)0x0008)      /* PA3 */
#define SDO                     ((uint16_t)0x0010)      /* PA4 */
#define SINT2                   ((uint16_t)0x0020)      /* PA5 */
#define SINT1                   ((uint16_t)0x0040)      /* PA6 */
